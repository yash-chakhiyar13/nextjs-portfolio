...
//             YC
//           </div>
//           <div className={`font-semibold transition-transform ${scrolled ? 'text-base' : 'text-xl'}`}>
//             Yash Chakhiyar
//           </div>
//         </Link>
  ...
  return (
    ...
    >
      <Link href="/" className="flex items-center gap-3 group">
        ...
        <div className="flex flex-col leading-none">
          <span className="font-semibold text-base select-none text-accent group-hover:text-primary transition-colors">
            Yash Chakhiyar
          </span>
          <span className="text-xs text-gray-500">Full-stack • AI • Sports</span>
        </div>
